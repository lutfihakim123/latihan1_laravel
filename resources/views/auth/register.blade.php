...
<form action="/register"  method="post">
    ...
    <br><br>
    <span >Have Account ? <a href="/login" style="text-decoration: none;" class="text-primary"> Login Here !!!</a> OR <a href="/" style="text-decoration: none;" class="text-danger"> Back Home</a>  </span>
</form>
